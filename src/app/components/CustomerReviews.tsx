    ...
    <section id={SECTION_IDS.testimonials} className={`w-full bg-[#f3f5f6] py-20 relative ${SCROLL_ANCHOR_CLASS}`}>
      <div className="max-w-[1440px] mx-auto px-6 lg:px-20">
        ...
        <div className="relative pb-16 h-[600px] md:h-[700px] lg:h-[800px] overflow-hidden">
          ...
          {/* Gradient fade at bottom of reviews */}
        ...
        {/* Rate Your Stay Form */}
        <div className="relative -mt-24 mx-auto max-w-[1000px] bg-white rounded-[24px] shadow-[0px_30px_80px_0px_rgba(0,0,0,0.1)] p-8 md:p-12 z-10">
              ...
              <div className="flex gap-2">
                {[1, 2, 3, 4, 5].map((star) => (
                  <button
                    key={star}
                    type="button"
                    className="relative w-11 h-11 transition-transform hover:scale-110 focus:outline-none"
          ...
          <div className="mt-10 flex justify-center">
            <button className="bg-[#12161D] text-white px-10 py-4 rounded-full font-medium text-lg hover:bg-[#12161D]/90 transition-colors shadow-sm">
              Submit A Review
            </button>
          </div>
        </div>
